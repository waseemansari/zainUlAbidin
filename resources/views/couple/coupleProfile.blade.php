                ...
                <div class="col-md-12">
                    <div class="dashboard-page-head">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="action-block"> <a href="{{url('dashboard')}}" class="btn btn-default">Back</a> </div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-7 dashboard-form calender bg-white mb30">
                            @if(session()->has('successMessageProfile'))
                                ...
                                @if(auth::user()->images=='')
                                            ...
                                            @endif
                            <form class="form-horizontal" action="{{route('couple.changeAvatar')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class=" row">
                                ...
                                @endif
                                <form class="form-horizontal" action="{{route('couple.changeInfo')}}" method="POST">
                                    @csrf
                        ...
                        <div class="col-md-5 dashboard-form">
                            <div class="bg-white pinside40 mb30">
                                ...
                                @endif
                                <form class="form-horizontal" action="{{route('couple.changePassword')}}" method="POST">
                                    @csrf
                                    <!-- Form Name -->
