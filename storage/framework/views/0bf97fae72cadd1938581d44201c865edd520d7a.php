    ...
    <div class="container">
        <div class="row">
            <div class="intro-block">
                <div class="col-md-offset-2 col-md-8">
                    <div class="template-box"><img src="<?php echo e(asset('template/images/budget-hero.png')); ?>" alt="" class="img-responsive"></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title text-center">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-primary mt20">Start planning Today</a> </div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section-space100 bg-light">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="app-mobile"> <img src="<?php echo e(asset('template/images/app-screen.png')); ?>" alt=""> </div>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts._template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\findmevenues\resources\views/planning/planningBudget.blade.php ENDPATH**/ ?>