        ...
        <div class="container">
            ...
            <div class="budget-board bg-white row" >
                ...
                <div class="list-group col-md-10" style="padding: 10px;">
                    <form action="<?php echo e(route('couple.updateToDoList', $toDoList->id)); ?>" method="POST">
                          <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e($toDoList->name); ?>" required autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="date" value="<?php echo e($toDoList->date); ?>" required autocomplete="date" autofocus>
...
unset($__errorArgs, $__bag); ?>" rows="5"><?php echo e($toDoList->description); ?></textarea>
...
<?php echo $__env->make('layouts._template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\findmevenues\resources\views/couple/toDoList/edit.blade.php ENDPATH**/ ?>