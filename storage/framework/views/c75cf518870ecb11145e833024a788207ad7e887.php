        ...
        <div class="container">
                ...
                <div class="col-md-12">
                    <div class="dashboard-page-head">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="action-block"> <a href="<?php echo e(url('dashboard')); ?>" class="btn btn-default">Back</a> </div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 profile-dashboard">
                    <div class="row">
                        <div class="col-md-7 dashboard-form calender bg-white mb30">
                            <?php if(session()->has('successMessageProfile')): ?>
                                ...
                                <?php if(auth::user()->images==''): ?>
                                            ...
                                            <?php endif; ?>
                            <form class="form-horizontal" action="<?php echo e(route('couple.changeAvatar')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class=" row">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php endif; ?>
                                <form class="form-horizontal" action="<?php echo e(route('couple.changeInfo')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-5 dashboard-form">
                            <div class="bg-white pinside40 mb30">
                                ...
                                <?php endif; ?>
                                <form class="form-horizontal" action="<?php echo e(route('couple.changePassword')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <!-- Form Name -->
...
<?php echo $__env->make('layouts._template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\findmevenues\resources\views/couple/coupleProfile.blade.php ENDPATH**/ ?>