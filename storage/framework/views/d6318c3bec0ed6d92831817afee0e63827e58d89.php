...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('template/css/fontello.css')); ?>">
    <!-- Template style.css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('template/css/style.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('template/css/owl.carousel.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('template/css/owl.theme.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('template/css/owl.transitions.css')); ?>">
...
<body>
    ...
    <!-- inner section -->
     <?php echo $__env->make('pageTemplate._header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->yieldContent('indexPage'); ?>
    <!-- end inner section -->   
    <div class="footer">
        <!-- Footer -->
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 ft-link">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo e(route('about-us')); ?>">News</a></li>
                        <li><a href="<?php echo e(route('about-us')); ?>">Career</a></li>
                        <li><a href="<?php echo e(route('about-us')); ?>">Privacy Policy</a></li>
                        <li><a href="<?php echo e(route('about-us')); ?>">Terms of Use</a></li>
                    </ul>
                </div>
    ...
    <!-- Flex Nav Script -->
    <script src="<?php echo e(asset('template/js/jquery.flexnav.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('template/js/navigation.js')); ?>"></script>
    <!-- slider -->

    <script src="<?php echo e(asset('template/js/owl.carousel.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('template/js/slider.js')); ?>"></script>
    <!-- testimonial -->
    <script type="text/javascript" src="<?php echo e(asset('template/js/testimonial.js')); ?>"></script>
    <!-- sticky header -->
    <script src="<?php echo e(asset('template/js/jquery.sticky.js')); ?>"></script>
    <script src="<?php echo e(asset('template/js/header-sticky.js')); ?>"></script>
    <script src="<?php echo e(asset('template/js/offset.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\findmevenues\resources\views/layouts/_template.blade.php ENDPATH**/ ?>