        ...
        <div class="row">
            <div class="intro-block">
                <div class="col-md-offset-1 col-md-10">
                    <div class=" "><img src="<?php echo e(asset('template/images/hero-to-do.png')); ?>" alt="" class="img-responsive"></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="cta-block text-center ">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-primary mt20">Start Planning Today</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section-space100">
        <div class="container">
          ...
          Manage To-Dos</h1>
                ...
                <div class="col-md-6">
                    <div class="template-box"><img src="<?php echo e(asset('template/images/to-do-app-screen.png')); ?>" alt="" class="img-responsive"></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="cta-block text-center section-space60">
                        <h1>Start Planning Your Wedding Day</h1>
                        <p>Just Engaged - Start Your First Wedding Planning To Do, Budget, Checklist, Guest list, Favourite.</p>
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-primary mt20">Start planning Today</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-offset-1 col-md-6">
                    <div class="tool-description text-center">
                        ...
                        <a href="#"><img src="<?php echo e(asset('template/images/button-app-store.png')); ?>" alt=""></a>
                        <a href="#"><img src="<?php echo e(asset('template/images/button-google-play.png')); ?>" alt=""></a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="app-mobile">
                        <img src="<?php echo e(asset('template/images/app-screen.png')); ?>" alt="" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts._template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\findmevenues\resources\views/planning/planningToDo.blade.php ENDPATH**/ ?>