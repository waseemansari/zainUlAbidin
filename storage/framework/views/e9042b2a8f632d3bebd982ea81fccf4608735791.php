            ...
            <div class="col-md-12">
             ...
             <small <?php if($key->date<=$currentDate): ?> style="color: red" <?php endif; ?>>
                <?php echo e(Carbon\Carbon::createFromFormat('Y-m-d', $key->date)->format('d M Y')); ?>
                                             ...
                                             <a href="#" class="btn-circle" title="Edit list">
...
<?php echo $__env->make('layouts._template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\findmevenues\resources\views/couple/coupleChecklist.blade.php ENDPATH**/ ?>